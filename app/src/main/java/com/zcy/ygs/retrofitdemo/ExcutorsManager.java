...
public class ExcutorsManager {
    private static ExcutorsManager mInstance=new ExcutorsManager();
    public static ExcutorsManager getInstance(){
        return mInstance;
    }
